...
WizardLicense=许可协议
LicenseLabel=请在继续之前<a target="_blank" href="http://book.2cto.com/" class="keylink" style="border:none; padding:0px; margin:0px; color:rgb(51,51,51); text-decoration:none; font-size:14px; background:none">阅读</a>以下重要信息！
...
WizardSelectComponents=选择<a target="_blank" href="http://www.2cto.com/kf/all/zujian/" class="keylink" style="border:none; padding:0px; margin:0px; color:rgb(51,51,51); text-decoration:none; font-size:14px; background:none">组件</a>
...
ConfirmDeleteSharedFile2=下列共享文件不再被其他程序使用，要清除吗？%n%n如果其他程序仍然使用此文件，却被删除的话，那些程序可能无法正常运行。如果你不确定，请选择“否”。留下此文件对你的<a target="_blank" href="http://www.2cto.com/os/" class="keylink" style="border:none; padding:0px; margin:0px; color:rgb(51,51,51); text-decoration:none; font-size:14px; background:none">系统</a>也不会有什么损害。
